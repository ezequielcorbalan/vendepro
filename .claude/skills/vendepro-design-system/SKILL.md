...
El proyecto tiene 46 componentes en `src/components/ui` y 24 reglas escritas en
...
Están las 24 en `doc/ds-visual-rules.md` con ❌/✅ y su grep de auditoría. Estas
...
- `doc/ds-visual-rules.md` en el repo — las 24 reglas con ❌/✅ y su grep de auditoría.
