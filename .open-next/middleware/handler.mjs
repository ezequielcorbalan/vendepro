...
var BuildId = "QKZeUjm5XLvzHYKfh6C0u";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|logo.png|logo-footer.png|images).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|logo.png|logo-footer.png|images).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "QKZeUjm5XLvzHYKfh6C0u", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "60fwdjN4mp1dC93Tn7ADWvK+H5JoVfyN1tybMvGYQGs=", "__NEXT_PREVIEW_MODE_ID": "ba015aaee7147fd88409855955408675", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "ca6c33c7edd184fc9900a71f1d6f5ba60c406595038d21b302f97c2fe921d175", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "f9c4aa589664530016e669c06d39b1d4f61c16647107faa2df5961d52b74c233" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/logout/route": "/api/auth/logout", "/api/create-agent/route": "/api/create-agent", "/api/extract-kiteprop/route": "/api/extract-kiteprop", "/api/auth/login/route": "/api/auth/login", "/api/extract-metrics/route": "/api/extract-metrics", "/api/properties/[id]/price/route": "/api/properties/[id]/price", "/api/reports/route": "/api/reports", "/api/properties/route": "/api/properties", "/api/properties/[id]/status/route": "/api/properties/[id]/status", "/favicon.ico/route": "/favicon.ico", "/(auth)/login/page": "/login", "/r/[slug]/historial/page": "/r/[slug]/historial", "/page": "/", "/r/[slug]/page": "/r/[slug]", "/(dashboard)/admin/agentes/page": "/admin/agentes", "/(dashboard)/propiedades/[id]/page": "/propiedades/[id]", "/(dashboard)/admin/agentes/nuevo/page": "/admin/agentes/nuevo", "/(dashboard)/dashboard/page": "/dashboard", "/(dashboard)/propiedades/nueva/page": "/propiedades/nueva", "/(dashboard)/propiedades/[id]/reportes/nuevo/page": "/propiedades/[id]/reportes/nuevo", "/(dashboard)/propiedades/page": "/propiedades" };
