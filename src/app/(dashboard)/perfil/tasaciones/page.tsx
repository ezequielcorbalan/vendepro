    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 flex items-center gap-2">
          <FileText className="w-6 h-6 text-[#ff007c]" /> Mi configuraci&oacute;n de tasaciones
        </h1>
        <p className="text-sm text-gray-400 mt-1">Videos, textos, datos de mercado y CTAs que se usan en tus landings de tasaci&oacute;n</p>
      </div>
              ...
              {settingFields.filter(f => f.group === group).map(field => {
                ...
                return (
                  <div key={field.key}>
                    ...
                    {field.type === 'textarea' ? (
                      <textarea
                        value={settings[field.key] || ''} onChange={e => setSettings(prev => ({ ...prev, [field.key]: e.target.value }))}
