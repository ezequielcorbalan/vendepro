      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href={publicUrl} target="_blank" className="inline-flex items-center gap-2 text-sm text-brand-gray border border-gray-300 px-3 py-2 rounded-lg hover:bg-gray-50">
              <ExternalLink className="w-4 h-4" /> Ver como propietario
            </a>
            <Link href={`/propiedades/${id}/reportes/nuevo`} className="inline-flex items-center gap-2 bg-brand-pink text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90">
