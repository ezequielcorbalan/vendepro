          ...
          {comparables.map((c, idx) => (
            <div key={idx} className="border border-gray-200 rounded-lg p-4 mb-3 space-y-3">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                <div className="col-span-2"><label className="block text-[10px] text-gray-400">Direcci&oacute;n</label><input value={c.address} onChange={e => { const u = [...comparables]; u[idx] = { ...u[idx], address: e.target.value }; setComparables(u) }} className={inputClass} /></div>
                ...
                <div><label className="block text-[10px] text-gray-400">m&sup2; cubierto</label><input type="number" value={c.covered_area} onChange={e => { const u = [...comparables]; u[idx] = { ...u[idx], covered_area: e.target.value }; setComparables(u) }} className={inputClass} /></div>
                <div><label className="block text-[10px] text-gray-400">D&iacute;as publicado</label><input type="number" value={c.days_on_market} onChange={e => { const u = [...comparables]; u[idx] = { ...u[idx], days_on_market: e.target.value }; setComparables(u) }} className={inputClass} /></div>
                <div><label className="block text-[10px] text-gray-400">Vistas 30d</label><input type="number" value={c.views_per_day} onChange={e => { const u = [...comparables]; u[idx] = { ...u[idx], views_per_day: e.target.value }; setComparables(u) }} className={inputClass} /></div>
                ...
                <div className="col-span-2 sm:col-span-3"><label className="block text-[10px] text-gray-400">URL aviso</label><input value={c.zonaprop_url} onChange={e => { const u = [...comparables]; u[idx] = { ...u[idx], zonaprop_url: e.target.value }; setComparables(u) }} className={inputClass} /></div>
              </div>
            </div>
          ))}
