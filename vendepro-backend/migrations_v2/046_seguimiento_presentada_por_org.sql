...
--
-- ⚠️  NO APLICAR hasta que se haya sacado el bloque `autoFollowup` de
--     AdvanceLeadStageUseCase (advance-lead-stage.ts). Mientras el hardcode
--     siga ahí, cada paso a "presentada" crearía DOS eventos de seguimiento:
--     uno el código y otro esta automatización.
--
