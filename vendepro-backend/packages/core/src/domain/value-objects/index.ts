...
export { MARKETING_PERIODS, parseMarketingPeriod, marketingPeriodRanges, periodDelta } from './marketing-period'
export type { MarketingPeriod, DateRange, MarketingPeriodRanges } from './marketing-period'
export { CAMPAIGN_GOALS, isCampaignGoal, goalForPipeline, splitCampaignsByGoal } from './campaign-goal'
export type { CampaignGoal, CampaignWithGoal, SplitCampaignsResult } from './campaign-goal'
