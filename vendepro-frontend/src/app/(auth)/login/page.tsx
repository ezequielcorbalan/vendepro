      ...
      <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-8 w-full max-w-md relative z-10 border border-white/50">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-br from-brand-pink to-brand-orange text-white font-medium py-2.5 rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 shadow-sm"
          >
            {loading ? 'Ingresando...' : 'Ingresar'}
          </button>

          <div className="text-center">
            <Link href="/forgot-password" className="text-sm text-gray-500 hover:text-brand-pink transition-colors">
