    ...
    <div className="min-h-screen bg-white">
      <nav className="border-b border-gray-100 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-8 flex items-center h-16">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-control bg-gradient-to-br from-brand-pink to-brand-orange flex items-center justify-center">
              <span className="text-white font-black text-[10px] tracking-tight">VP</span>
            </div>
            <span className="font-bold text-ink">Vendé<span className="text-brand-pink">Pro</span></span>
          </Link>
        </div>
      </nav>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-8 py-12">
        ...
        <div className="prose prose-gray max-w-none text-sm leading-relaxed space-y-6">
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">1. Servicio</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">2. Planes y facturación</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">3. Límites de uso</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">4. Inteligencia artificial</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">5. Datos y privacidad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">6. Cancelación</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">7. Beta</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">8. Responsabilidad</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-ink mb-3">9. Contacto</h2>
