    ...
    <div className="flex flex-col items-center text-center px-4 py-6 gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-sm">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-[#ff007c] to-[#ff8017] text-white px-4 py-3 rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity shadow-md shadow-pink-200"
        >
