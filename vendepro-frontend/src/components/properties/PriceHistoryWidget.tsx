  ...
  return (
    <>
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
        ...
        <div className="bg-gradient-to-br from-[#ff007c]/5 to-[#ff8017]/5 rounded-xl p-4 mb-3 border border-[#ff007c]/20">
          ...
          >
            ...
            <div className="p-6">
              ...
              <button
                ...
                className="mt-5 w-full bg-gradient-to-br from-[#ff007c] to-[#ff8017] text-white text-sm font-medium py-2.5 rounded-lg hover:opacity-90 disabled:opacity-50"
              >
