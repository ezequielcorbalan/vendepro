    ...
    <div className="space-y-4 p-3">
      ...
      <div className={`grid grid-cols-1 gap-4 ${compact ? '' : 'md:grid-cols-2'}`}>
        <div className="space-y-2 rounded border border-gray-200 bg-gray-50/40 p-3">
          <label className="flex flex-col gap-1">
            <span className="text-xs uppercase tracking-wide text-gray-600">Nombre del gráfico 1</span>
            <input
              type="text"
        ...
        <div className="space-y-2 rounded border border-gray-200 bg-gray-50/40 p-3">
          <label className="flex flex-col gap-1">
            <span className="text-xs uppercase tracking-wide text-gray-600">Nombre del gráfico 2</span>
            <input
              type="text"
