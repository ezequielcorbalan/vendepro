...
export function ZoneMapForm({ data, onPatch }: Props) {
  return (
    <div className="space-y-3 p-3">
      ...
      <label className="flex flex-col gap-1">
        <span className="text-xs uppercase tracking-wide text-slate-600">Subtítulo (barrio o zona)</span>
        <input
          type="text"
      ...
      <div className="flex flex-col gap-1">
        <span className="text-xs uppercase tracking-wide text-slate-600">Imagen del mapa</span>
        <ImageUpload
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="flex flex-col gap-1">
          <span className="text-xs uppercase tracking-wide text-slate-600">Mín USD/m²</span>
          <input
            type="number"
            min={0}
        ...
        <label className="flex flex-col gap-1">
          <span className="text-xs uppercase tracking-wide text-slate-600">Promedio USD/m²</span>
          <input
            type="number"
            min={0}
        ...
        <label className="flex flex-col gap-1">
          <span className="text-xs uppercase tracking-wide text-slate-600">Mediana USD/m²</span>
          <input
            type="number"
            min={0}
        ...
        <label className="flex flex-col gap-1">
          <span className="text-xs uppercase tracking-wide text-slate-600">Publicadas</span>
          <input
            type="number"
            min={0}
