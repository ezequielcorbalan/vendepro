...
describe('hydrateBlocks', () => {
  ...
  it('resolves comparables', () => {
    const appraisal = { ...baseAppraisal, comparables: [{ id: 'c1', appraisal_id: 'a1', kind: 'publicacion' as const, zonaprop_url: null, address: 'X', total_area: 100, covered_area: 80, price: 300000, usd_per_m2: 3000, days_on_market: null, views_per_day: null, age: null, closing_price_usd: null, closed_at: null, source_sold_property_id: null, sort_order: 0 }] }
    const snapshot: TemplateBlock[] = [
