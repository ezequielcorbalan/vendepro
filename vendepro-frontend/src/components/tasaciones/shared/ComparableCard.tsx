...
import { X, Sparkles, ImageIcon, Loader2 } from 'lucide-react'
import {
...
export function ComparableCard({ index, comparable, onPatch, onRemove }: Props) {
  ...
  const applyExtraction = (data: ExtractedComparable) => {
    // Solo pisamos los campos vacíos para no sobreescribir lo que el usuario tipeó.
  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-5">
      ...
      <div className="space-y-4">
        ...
        {/* Drop zone — paste, drop o file picker */}
        <div
          tabIndex={0}
          onPaste={handlePaste}
